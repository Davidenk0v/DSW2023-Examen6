-- Active: 1706637488904@@127.0.0.1@3306@filmdb
...
CREATE TABLE IF NOT EXISTS `choices` (
    `id` int NOT NULL, `user_id` int NOT NULL, `company_id` int NOT NULL, `created_at` timestamp NOT NULL, `updated_at` timestamp NOT NULL
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_spanish_ci;

-- --------------------------------------------------------

CREATE TABLE IF NOT EXISTS `companies` (
    `id` int NOT NULL, `name` varchar(40) COLLATE utf8mb4_spanish_ci NOT NULL, `url` varchar(100) COLLATE utf8mb4_spanish_ci NOT NULL, `mode` varchar(20) COLLATE utf8mb4_spanish_ci NOT NULL, `description` varchar(200) COLLATE utf8mb4_spanish_ci NOT NULL, `created_at` timestamp NOT NULL, `updated_at` timestamp NOT NULL
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_spanish_ci;
...
INSERT INTO
    `companies` (
        `id`, `name`, `url`, `mode`, `description`, `created_at`, `updated_at`
    )
VALUES (
    ...
    (
        13, 'STV', 'http://stvcanarias.com/ ', 'presencial', 'Distribución y reparación de máquinas de vending. Desarrollo de aplicaciones propias para la gestión de las reparaciones, etc.\r\n', '2024-01-30 13:11:36', '2024-01-30 13:11:36'
    ),
    (
...
CREATE TABLE IF NOT EXISTS `users` (
    `id` int NOT NULL, `name` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci NOT NULL, `password` varchar(40) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish_ci NOT NULL, `profesor` tinyint(1) NOT NULL, `created_at` timestamp NOT NULL, `updated_at` timestamp NOT NULL
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_spanish_ci;
...
INSERT INTO
    `users` (
        `id`, `name`, `password`, `profesor`, `created_at`, `updated_at`
    )
VALUES (
    ...
    (
        14, 'Cristo', '123', 0, '2024-01-30 12:57:49', '2024-01-30 12:57:49'
    ),
    (
